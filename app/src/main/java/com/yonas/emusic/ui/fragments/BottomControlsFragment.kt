...
import com.yonas.emusic.constants.Constants.ACTION_CAST_CONNECTED
import com.yonas.emusic.constants.Constants.ACTION_CAST_DISCONNECTED
import com.yonas.emusic.constants.Constants.ACTION_RESTORE_MEDIA_SESSION
import com.yonas.emusic.constants.Constants.NOW_PLAYING
import com.yonas.emusic.databinding.LayoutBottomsheetControlsBinding
import com.yonas.emusic.extensions.addFragment
import com.yonas.emusic.extensions.hide
...
import com.yonas.emusic.extensions.show
import com.yonas.emusic.models.CastStatus
import com.yonas.emusic.models.CastStatus.Companion.STATUS_PLAYING
import com.yonas.emusic.network.models.ArtworkSize
import com.yonas.emusic.ui.activities.MainActivity
import com.yonas.emusic.ui.bindings.setLastFmAlbumImage
import com.yonas.emusic.ui.bindings.setPlayState
import com.yonas.emusic.ui.fragments.base.BaseNowPlayingFragment
import com.yonas.emusic.ui.widgets.BottomSheetListener
    ...
    private fun setupUI() {
        ...
        binding.btnShuffle.setOnClickListener {
            when (nowPlayingViewModel.currentData.value?.shuffleMode) {
                SHUFFLE_MODE_NONE -> mainViewModel.transportControls()
                    .setShuffleMode(SHUFFLE_MODE_ALL)
                SHUFFLE_MODE_ALL -> mainViewModel.transportControls()
    ...
    private fun setupCast() {
        ...
        val castStatusObserver = Observer<CastStatus> {
            ...
            if (it.isCasting) {
                ...
                setLastFmAlbumImage(
                    binding.bottomContolsAlbumart,
                    it.castSongArtist,
                    it.castSongAlbum,
                    ArtworkSize.SMALL,
                    it.castAlbumId.toLong()
                )
                ...
                when (it) {
                    ...
                    ACTION_CAST_DISCONNECTED -> {
                        ...
                        mainViewModel.transportControls()
                            .sendCustomAction(ACTION_RESTORE_MEDIA_SESSION, null)
                    }
                }
            }
    }
