...
import com.yonas.emusic.databinding.ItemSongsBinding
import com.yonas.emusic.databinding.ItemSongsHeaderBinding
...
class SongsAdapter(val lifecycleOwner: LifecycleOwner) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            TYPE_SONG_HEADER -> {
                val viewBinding =
                    parent.inflateWithBinding<ItemSongsHeaderBinding>(R.layout.item_songs_header)
    ...
    class HeaderViewHolder constructor(
        var binding: ItemSongsHeaderBinding,
