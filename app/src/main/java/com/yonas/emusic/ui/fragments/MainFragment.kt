...
import com.yonas.emusic.PREF_START_PAGE
import com.yonas.emusic.R
import com.yonas.emusic.constants.StartPage
import com.yonas.emusic.databinding.MainFragmentBinding
...
import com.yonas.emusic.ui.activities.SettingsActivity
...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarLayout.toolbar.overflowIcon =
            safeActivity.drawable(R.drawable.ic_more_vert_black_24dp)
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        val adapter = Adapter(childFragmentManager).apply {
            ...
            addFragment(
                fragment = MediaItemFragment.newInstance(
                    MediaID(
                        TYPE_ALL_PLAYLISTS.toString(),
                        null
                    )
                ),
