...
import com.yonas.emusic.extensions.attachLifecycle
import com.yonas.emusic.extensions.ioToMain
import com.yonas.emusic.extensions.replaceFragment
import com.yonas.emusic.ui.activities.base.PermissionsActivity
import com.yonas.emusic.ui.fragments.SettingsFragment
...
class SettingsActivity : PermissionsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appThemePref.observe()
            ...
            .subscribe {
                val intent =
                    packageManager.getLaunchIntentForPackage(packageName) ?: return@subscribe
