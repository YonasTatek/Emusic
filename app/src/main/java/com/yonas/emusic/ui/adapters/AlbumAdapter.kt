 ...
 *
 */
package com.yonas.emusic.ui.adapters

import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.yonas.emusic.R
import com.yonas.emusic.databinding.ItemAlbumBinding
import com.yonas.emusic.databinding.ItemAlbumsHeaderBinding
import com.yonas.emusic.databinding.ItemArtistAlbumBinding
import com.yonas.emusic.extensions.dpToPixels
...
class AlbumAdapter constructor(private val isArtistAlbum: Boolean = false) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (isArtistAlbum) {
            ...
            return when (viewType) {
                TYPE_ALBUM_HEADER -> {
                    val viewBinding =
                        parent.inflateWithBinding<ItemAlbumsHeaderBinding>(R.layout.item_albums_header)
                    HeaderViewHolder(viewBinding, sortMenuListener)
                }
                TYPE_ALBUM_ITEM -> {
                    val viewBinding =
                        parent.inflateWithBinding<ItemAlbumBinding>(R.layout.item_album)
    ...
    class HeaderViewHolder constructor(
        var binding: ItemAlbumsHeaderBinding,
    ...
    class ViewHolder constructor(private val binding: ItemAlbumBinding) :
        RecyclerView.ViewHolder(binding.root) {
    ...
    class ArtistAlbumViewHolder constructor(val artistAlbumBinding: ItemArtistAlbumBinding) :
        RecyclerView.ViewHolder(artistAlbumBinding.root) {
