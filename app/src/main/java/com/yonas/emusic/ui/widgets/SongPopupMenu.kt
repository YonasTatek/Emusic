 ...
 *
 */
package com.yonas.emusic.ui.widgets
        ...
        setOnClickListener {
            ...
            popupMenu.setOnMenuItemClickListener {
                when (it.itemId) {
                    ...
                    R.id.popup_song_delete -> popupMenuListener?.deleteSong(
                        context,
                        adapterSong()!!
                    )
                    R.id.popup_song_remove_playlist -> popupMenuListener?.removeFromPlaylist(
                        adapterSong()!!,
                        playlistId
                    )
                }
