 ...
 *
 */
package com.yonas.emusic.playback
...
import com.yonas.emusic.constants.Constants.ACTION_NEXT
import com.yonas.emusic.constants.Constants.ACTION_PREVIOUS
import com.yonas.emusic.constants.Constants.APP_PACKAGE_NAME
import com.yonas.emusic.db.QueueEntity
import com.yonas.emusic.db.QueueHelper
import com.yonas.emusic.extensions.*
import com.yonas.emusic.models.MediaID
import com.yonas.emusic.models.MediaID.Companion.CALLER_OTHER
import com.yonas.emusic.models.MediaID.Companion.CALLER_SELF
import com.yonas.emusic.notifications.Notifications
import com.yonas.emusic.permissions.PermissionsManager
import com.yonas.emusic.playback.players.SongPlayer
import com.yonas.emusic.repository.*
import com.yonas.emusic.util.Utils.EMPTY_ALBUM_ART_URI
        ...
        if (mediaType == MEDIA_ID_ROOT.toString()) {
            ...
            when (mediaType?.toInt() ?: 0) {
                ...
                TYPE_PLAYLIST -> {
                    mediaId?.let {
                        mediaItems.addAll(
                            playlistRepository.getSongsInPlaylist(
                                it.toLong(),
                                caller
                            )
                        )
